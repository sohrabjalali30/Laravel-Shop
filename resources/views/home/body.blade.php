            ...
            <div class="tabs mt-6">
                <ul class="nav canvas-tabs tabs nav-tabs justify-content-center mb-4" id="tab-3" role="tablist" style="--bs-nav-link-font-weight: 600;">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="canvas-home-tab" data-bs-toggle="pill" data-bs-target="#home2" type="button" role="tab" aria-controls="canvas-home" aria-selected="true">New Arrivals</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="canvas-profile-tab" data-bs-toggle="pill" data-bs-target="#profile2" type="button" role="tab" aria-controls="canvas-profile" aria-selected="false">Best sellers</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="canvas-contact-tab" data-bs-toggle="pill" data-bs-target="#contact2" type="button" role="tab" aria-controls="canvas-contact" aria-selected="false">You may like</button>
                    </li>
                </ul>
            ...
            <div class="container">
                <div class="row col-mb-50">
                    ...
                    <div class="col-md-6 mb-5 subscribe-widget">
                        ...
                        <div class="widget-subscribe-form-result"></div>
                        <form id="widget-subscribe-form3" action="https://canvastemplate.com/include/subscribe.php" method="post" class="mb-0">
